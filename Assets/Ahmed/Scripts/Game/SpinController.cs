...
public class SpinController : MonoBehaviour {
    ...
    void Update() {
//		if(  circle1.transform.localPosition.z<=0|| circle1.transform.localPosition.z<=0.3)
//		circle1.transform.localPosition.z = 0.2f;
    }
...
//				print ("transform    z    " + pos.z);
                circle1.transform.position = pos;
				circle1.transform.position = new Vector3(pos.x,pos.y,-4.04f);
